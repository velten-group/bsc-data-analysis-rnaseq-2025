...
# Welcome to the RNAseq Data Analysis course
...
Make sure you get help if you encounter any problems.
...
if(version$major < 4 | version$minor < 4) {
  print("Your R version is not up-to-date. Please download the latest R version (>=4.4)")
} else {
