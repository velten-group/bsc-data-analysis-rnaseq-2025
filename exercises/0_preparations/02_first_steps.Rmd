...
<mark>**Your task**: Please generate a html version of this file (following the steps described below) and *send it to us by Friday 15 Nov*.</mark> 
...
<mark>**Task 11: Knit the .Rmd file with all your changes and solutions by clicking on the "Knit button" for the tasks and send the html to us. Make sure to change the author name to your name before knitting. Don't worry if you encounter problems, we will jointly go through the file on the first day of the course ** </mark>
